...
\paragraph{AECI-Var.}
Applies the SECI variance formula (Equation~\ref{eq:seci}) with grouping by AI
reliance instead of network community: within each agent type, agents are
median-split by their cumulative count of \emph{accepted} AI belief updates,
the belief variance of each type's AI-reliant half is compared with the global
variance, and the two type values are averaged.
