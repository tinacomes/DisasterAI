...
class DisasterModel(Model):
    ...
    def step(self):
        ...
        if self.tick % 5 == 0:
            ...
            # Also fix any plotting functions that display AECI data
            def plot_aeci_evolution(aeci_array, title_suffix=""):
                """Plots AECI (AI Call Ratio) evolution with Mean +/- IQR bands with proper bounds."""
